...
<!--xsi:schemaLocation="http://www.opengis.net/infragml/road/1.0 http://schemas.opengis.net/infragml/part4/1.0/road.xsd" -->
	<datasetID>
		<ID>
			<identifier>DS4a</identifier>
			<scope>OGC LandInfraSWG</scope>
		</ID>
	</datasetID>
	<name>Sample Part4a Dataset</name>
	<description>LandInfra dataset to test all possible content for Part4 Road (without CrossSections)
</description>
	<dateTime>2016-12-02T10:00:00</dateTime>
	<datasetVersion>1.0</datasetVersion>
	<application>manual</application>
	<author>Paul Scarponcini, Bentley Systems, Inc.  Modified by Erling Onstein to fit NorskInfra</author>
	...
	<linearElement>
		<LinearElement gml:id="le1">
			<gmllr:feature xlink:href="a1" xlink:title="alignment a1">
			</gmllr:feature>
            ...
            <infraN:norskeTillegg>
					...
					<infraN:dimensjonerendeParametre>
						<infraN:DimensjonerendeParametere_Veg>
							...
							<infraN:dimensjonerendeMotorkjøretøy>B</infraN:dimensjonerendeMotorkjøretøy>
							<infraN:dimensjonerendeTrafikkmengdeÅDT>6000-12000</infraN:dimensjonerendeTrafikkmengdeÅDT>
							<infraN:dimensjonerendeKjøremåte>B</infraN:dimensjonerendeKjøremåte>
							
							<infraN:maxOverhøydeProsent>8</infraN:maxOverhøydeProsent>
							<infraN:dimensjonerendeTrafikk>C</infraN:dimensjonerendeTrafikk>
						</infraN:DimensjonerendeParametere_Veg>
					</infraN:dimensjonerendeParametre>				
